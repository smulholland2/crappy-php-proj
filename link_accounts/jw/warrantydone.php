...
$NewExpDate  = $_GET["NewExpDateStr"];
	...
	echo "<br>";
	echo "<p style='text-align:center'><a href='index.php'><button style='background-color:#004a91;color:white;border:none;width:200px;height:35px'>Reactivate another student</button></a></p>";
	echo "<p style='text-align:center'><a href='printreceipt.php?NF=$NF&NL=$NL&NewUA=$NewUA&UU=$UU&NewPW=$NewPW&NewSD=$NewSD&NewExpDate=$NewExpDate' target='_blank'><button style='background-color:#004a91;color:white;border:none;width:200px;height:35px'>Print</button></a></p>";	

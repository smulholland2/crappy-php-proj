        ...
        <div class="col-md-12">
            <div class="page-header">
                ...
                <?php 
                    ...
                    if($_SESSION['course']['state'] == "Oregon" || $_SESSION['course']['state'] == "Washington"){
                        $special_message_state = $_SESSION['course']['state'];
                        echo "<div class='row'>";
                        echo "<div class='alert alert-info'>
                                This course is for information purposes only. This course is not approved by the state of $special_message_state.
                              </div>
                            ";
                        echo "</div>";
                    }
            ...
            <div class="row">
                 ...
                 <a class="btn btn-primary" href=<?php echo "/courses/shop/foodhandler/".$id; ?>>Buy It</a>                 
            </div>
            <br />
            <div class="row">            
                ...
                <br />
                <a href="/home/privacyh">Click here for privacy policy</a>
                <br />

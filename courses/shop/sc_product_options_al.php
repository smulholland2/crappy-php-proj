...
if($ProID == "WVBA" OR $ProID == "WVCH" OR $ProID == "WVMN" OR $ProID == "WVPE" OR $ProID == "WVPO" OR $ProID == "WVUP" OR $ProID == "WVWA" OR $ProID == "WVOH")
{
...
<p <?php if($ProID=="WVPE" OR $ProID=="WVPO"){echo"style='display:block;font-size:12px;text-align:center;padding:0px 20px 0px 20px'";}else{echo"style='display:none'";} ?>><strong> If you pay the county fee, your handler card will ONLY be valid in <?php if($ProID=="WVPE"){echo "Pendleton";} if($ProID=="WVPO"){echo"Pocahontas";} ?> County</strong></p>
<div id="img_details">
<div id="img_container"><img src="../images/<?php echo $ProID;?>1.png"></div>
<div id="details_container">
	<form method="get" action="sc_shopping_cart.php" <?php if ($ProID == "westvirginia"){ echo 'style="display:none;"'; }?> >
...
<div id="wrapper" <?php if ($ProID == "WVPE" OR $ProID == "WVPO"){ echo "style='display:block;margin-top:-40px' "; }else{ echo "style='display:none;' "; }?> >
<h2 style="text-align:center;color:#1E2B41;padding:0px 20px 0px 20px"><?php echo $Course_Name;?><?php if($purchase_license_keys=="yes"){echo" License Key";}?></h2>

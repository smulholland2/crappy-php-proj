...
if(!$AN_check){
    header("Location: qkstart.php?err=1");
}



session_start();
$_SESSION["displayname"] = "QK Inc.";
$_SESSION["admintable"] = "07L3";
$_SESSION["menu"] = "/admin/company/qkindex.php";
...
<p><a href="/admin/company/qkindex.php?UN=<?php echo $UN ;?>" class="btn btn-primary" role="button">Yes</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">No</button></p>
<br>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="qkupdate.php" method="get">

...
if($VC != "")
{
    $SQL1="SELECT * FROM [07SL1] WHERE VC='$VC' ";				
    $resultset1=mssql_query($SQL1, $con);
        while ($row = mssql_fetch_array($resultset1)) 
        {
            ...
            $ifl_price = $row['IL'];
			$ifl_price = number_format($ifl_price,2);
...
<div class="container">
    ...
    <form class="form-horizontal" action='update_pricing_group_db.php' method='get'>
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-7">San Diego Food Handler Training:</label>
                        <div class="col-sm-2">
                        <input type="text" class="form-control" name="casd" value="<?php echo $sd_price;?>">
                        </div>
                    </div>
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            ...
            <div id="collapse2" class="panel-collapse collapse">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-7">Illinois Refresher Course:</label>
                        <div class="col-sm-2">
                        <input type="text" class="form-control" name="ifl" value="<?php echo $ifl_price;?>">
                        </div>
                    </div>

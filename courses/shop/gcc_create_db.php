...
if($AN_check){
    ...
    $SQL = "INSERT INTO [07O6] (AN, NCON, NCPY, OP, AA1, AA2, ACI, AST, AZ, ACO, AP, AM, NF, NL, DIV_NAME) 
            VALUES ('$UN', '$NCON', 'Ghirardelli', 'Other', '$AA1', '$AA2', '$ACI', '$AST', '$AZ', 'USA', '$AP', '$AM', '$NF', '$NL', '$DIV_NAME') ";
...
if($AN_check2){
    ...
    $SQL3 = "INSERT INTO [07L3] (AN, AC, VC, TRAIN_PERIOD, CTRLEXAM) 
            VALUES ('$UN', 'pending', 'gcer', 180, 1) ";
...
elseif(!$resultset3){
    ...
    echo "<h1 style='text-align:center;margin-top:100px'>Your account has been sent to the administrator for approval. You will be notified by email when your account is approved.</h1>";
    			...
    			$to = "dp@tapseries.com";
				$subject = "Ghirardelli New Account Request";

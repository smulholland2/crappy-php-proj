...
mssql_select_db($database, $con) or die('Could not select a database.');
    ...
    //Get Course Price
	$SQL = "SELECT [04C] FROM [07SL1] WHERE VC = 'tapseries' ";				
	$resultset=mssql_query($SQL, $con); 	
		while ($row = mssql_fetch_array($resultset)) 
		{
		     $haccp_price = $row['04C'];
			 $haccp_price = number_format($haccp_price,2);
		}
...
<div class="course_container">
	...
	<div class="content">
		<div class="title">
			<h4><a href = "/courses/shop/haccp/nhaccp"><?php echo $haccp_c_name; ?></a></h4>
		</div>
        <a href = "/courses/shop/haccp/nhaccp">
		<div class="price">
			<h4>$<?php echo $haccp_price; ?></h4>
		</div>
        </a>
	</div>
</div>
    ...
    <div class="container">
    <div class='well' style="margin-top:100px;margin-bottom:100px">

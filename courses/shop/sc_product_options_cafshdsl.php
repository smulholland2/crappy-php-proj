...
if($discode == '')
{
	$SQL = "SELECT [01CAEC]  FROM [07SL1] WHERE VC = 'tapseries' ";				
...
{
	$SQL2 = "SELECT [01CAEC]  FROM [07SL1] WHERE VC = '$discode' ";				
...
<html>
<head>
<title>California Food Handler</title>
...
<h2 style="text-align:center;color:#1E2B41">California Food Handler</h2>
<p style="text-align:center"><img src="../images/califsh.png"></p>

<form method="get" action="sc_shopping_cart.php">
	<input type="hidden" name="Qty" value="1">
	<input type="hidden" name="ProName" value="California Food Handler">
	<input type="hidden" name="ProID" value="califsh">
	<input type="hidden" name="ProPrice" value="<?php echo $ProPrice; ?>">
	<p style="text-align:center"><button tyle="submit">Buy Now</button></p>
</form>

<p style="margin-left:20px"><strong>Course:</strong> California Food Handler</p>

    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <div class="row col-sm-12">
                <div class="alert alert-info" role="alert">STUDENT INFORMATION</div>
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td>Last Name:</td>
                            <td><?php echo $student[0]["NL"] ?></td>                            
                        </tr>
                        <tr>
                            <td>First Name:</td>
                            <td><?php echo $student[0]["NF"] ?></td>
                        </tr>
                        <tr>
                            <td>Date Added:</td>
                            <td><?php echo $student[0]["DA"] ?></td>
                        </tr>
                        <tr>
                            <td>User Name:</td>
                            <td><?php echo $student[0]["UU"] ?></td>
                        </tr>
                        <tr>
                            <td>User Email:</td>
                            <td><?php echo $student[0]["UM"] ?></td>
                        </tr>                        
                    </tbody>
                </table>
            </div>

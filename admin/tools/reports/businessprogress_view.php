...
session_start();
$multi_user = $_SESSION['user'];


$SQL1="SELECT weeks, minimumScore FROM CCCR WHERE corp='$multi_user' ";
...
<div class="container" style='margin-top:90px;margin-bottom:90px'>
    ...
    <p><strong>REPORT COLORS</strong></p>
     ...
     <p><strong>Unit: </strong><?php echo $multi_user;?></p>
...
<?php
        ...
        $count=0;
            ...
            echo "<br>";
            echo "<p><strong>Unit/Class Administrator: </strong></p>";
        ...
        $SQL3 = "SELECT NF, NL, UU, UC, UM, DA, DE, DS FROM [01D] WHERE UA='$multi_user' AND ME=1 AND DA >= '$start' AND  DA <= '$end' ORDER BY NL";		
        ...
        while ($row = mssql_fetch_array($resultset3)) 
        {
            ...
            //$SQL14 = "INSERT INTO CCCR_list (lastname, firstname) VALUES ('firstname', 'lastname')";

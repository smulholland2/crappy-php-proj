...
$SQL1="SELECT weeks, minimumScore FROM CCCR WHERE corp='$corp_user' ";
...
<div class="container" style='margin-top:90px;margin-bottom:90px'>
    ...
    <a href="/account/login" class="btn btn-primary" <?php if($_GET["emailReport"]){echo "style='display:none'";}?>>Main Menu</a>
    <div class="well">

...
$SQL = "SELECT *  FROM Invoice2	WHERE UA = '$acct' AND Month = '$month' AND Year = '$year' ORDER BY InvoiceNum ASC";				
...
//$invoicenum= odbc_result($resultset, "InvoiceNum");
//$paid= odbc_result($resultset, "Paid");
//$comment1= odbc_result($resultset, "comment1");
//$comment2= odbc_result($resultset, "comment2");
//$comment3= odbc_result($resultset, "comment3");

if($paid == 'yes'){
	$paidC = 'They paid already.';
}
if($paid == 'email'){
	$paidC = 'We sent them an email, they have not paid yet.';
}
if($paid == 'no'){
	$paidC = 'We HAVE NOT sent them an email.';
}


echo "<br>";
echo "<p style='text-align:center;font-size:14px' id='paidCtext'>$paidC </p>";
...
<?php echo "<p style='text-align:center'><a href='results.html'><button>Go Back</button></a></p>";
?>

<?php 
echo "
<p  style='text-align:center'><a href='sendinvtoemail.php?acct=$acct&course=$course&price=$price&count=$count&total=$total&invoicenum=$invoicenum&company=$company&month=$month&year=$year&emailx={{emailx}}&comment1={{comment1}}&comment2={{comment2}}&comment3={{comment3}}&total2=$total2&company2=$company2&total3=$total3&company3=$company3&total4=$total4&company4=$company4&total5=$total5&company5=$company5&total6=$total6&company6=$company6
&total7=$total7&company7=$company7&total8=$total8&company8=$company8&total9=$total9&company9=$company9&total10=$total10&company10=$company10&total11=$total11&company11=$company11&total12=$total12&company12=$company12&total13=$total13&company13=$company13&total14=$total14&company14=$company14&total15=$total15&company15=$company15&total16=$total16&company16=$company16&total17=$total17&company17=$company17&total18=$total18&company18=$company18'><button>Re-send Invoice</button></a></p>
"
 ?>

<!--<p style="text-align:center"><input id="emailbox" type="text" ng-init="emailx='<?php echo $UM; ?>'" ng-model="emailx"></p>-->

<!--<p style="text-align:center">mg@tapseries.com<input class="emailbox" type="radio" ng-model="emailx" value="mg@tapseries.com" ></p>-->
 <p style="text-align:center" id="sandraemail">sk@tapseries.com<input class="emailbox" type="radio" ng-model="emailx" value="sk@tapseries.com" ></p>
<p style="text-align:center" id="companyemail"><?php echo $UM; ?><input class="emailbox" type="radio" ng-model="emailx" value="<?php echo $UM; ?>" ></p>

<p style="text-align:center" id="instructions1">Click on <b>TAP Series</b> on the invoice to hide all bottons</p>


<div id="wrapper">
<br>
<h1 ><span style="font-size:18px;margin-left:20px;float:left;cursor:pointer" id="switchHide">TAP Series</span>
...
<table>
  ...
  <tr>
	...
	<input type="text" style="width:550px;border:none" maxlength="90" ng-model="comment1" ng-init="comment1='<?php echo $comment1; ?>'">
	<input type="text" style="width:550px;border:none" maxlength="90" ng-model="comment2" ng-init="comment2='<?php echo $comment2; ?>'">
	<input type="text" style="width:550px;border:none" maxlength="90" ng-model="comment3" ng-init="comment3='<?php echo $comment3; ?>'">
	</td>
  </tr>
</table>
</div>
...
<p style="text-align:center"><button id="dltbtn">Delete Invoice</button></p>

<div id="dinv">
<br>
<p style="text-align:center">Are you sure you want to delete this invoice?</p>

<?php echo "<p style='text-align:center'><a href='deleteinvoiceengine.php?acct=$acct&month=$month&year=$year&invoicenum=$invoicenum'><button>Yes</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id='dltno'>No</button></p>";?>

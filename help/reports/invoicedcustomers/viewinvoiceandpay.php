...
<br>
<span style="margin-left:20px">CA = California Food Handler &nbsp;&nbsp; FLFH = Florida Food Handler &nbsp;&nbsp; WVFH = West Virginia Food Handler</span>
<br>
...
<p style="text-align:center" ng-show='<?php echo $paidbtn; ?>'><button type="submit" style="background-color:white;border:none;cursor:pointer"><img src='http://www.tapseries.com/help/TPReport/InvoicedCustomers/pay_online_button.png'></button></p>

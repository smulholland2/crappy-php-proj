...
$to = $emailx;
         ...
         $message .= "If button does not display click<a href='http://www.tapseries.com/invoicedcustomers/viewinvoiceandpay.php?emailinfo=$emailinfo'> here </a> to view invoice";
		 $message .= "<br><br>";
		 
         $message .= "<a href='http://www.tapseries.com/invoicedcustomers/viewinvoiceandpay.php?emailinfo=$emailinfo'><img src='http://www.tapseries.com/invoicedcustomers/viewinvoicebtn.png'></a>";

...
//get student info
$SQL = "SELECT * FROM [01D] WHERE UU='$username' ";
...
<div class="container">
    ...
    <div class="alert alert-success alert-dismissable fade in">
        ...
        <strong>Success!</strong> This student has been added to <strong>Food Safety Manager Certification Training</strong>.
    </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Food Safety Manager Certification Training</td>
      </tr>
      <tr>
        <td>Language:</td>
        <td><?php echo "$lang";?></td>
  ...
  <br>
  <a href="index.php" class="btn btn-primary" role="button">Add More Students</a>

...
<div id="wrapper">
    <div class="container">
        <div class="col-md-12">
			...
			<br />
            <div class="row">
                 <form action='enrollaa.php' name='studentform' onsubmit='return validateForm()' method='POST'>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="coursename" value="Allergen Awareness" disabled/>
                        </div>
                        <div class="clearfix"></div>
                        <div class="form-group col-md-12">
                        ...
                        <div class="clearfix"></div>
                        <div class="form-group col-md-12">
                            <label for=""><span class="text-danger">*</span> Student Birthdate:</label>
                        </div>

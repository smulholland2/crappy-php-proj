 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	$from="orders@tapseries.com";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="admin@tapseries.com";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
	...
	$smtp->host_name="smtp.emailsrvr.com";       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
...
//	$smtp->http_proxy_host_port=465;   /* Change this variable if you need to connect to SMTP server via an HTTP proxy */
	...
	$smtp->localhost="tapseries.xyz";       /* Your computer address */
	...
	$smtp->user="orders@tapseries.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="buythis";                 /* Set to the authetication password */

<?php
    ...
    if(isset($_GET["discode"])){
        ...
        $sql = "SELECT logo, html, js, css FROM [4upages] WHERE discode = '$discode' ";
...
<div class="container text-center">
    ...
    <img src="images4u/<?php echo $logo ?>">
    <br><br>
    <?php echo $htmlcode; ?>
    <br>
    <h4><strong>&#169; Copyright <?php echo $cyear=date("Y"); ?> TAP Series, LLC <br><a style='text-decoration:none' href='http://www.tapseries.com/privacy.asp'>Privacy Policy</a></strong></h4>
</div>

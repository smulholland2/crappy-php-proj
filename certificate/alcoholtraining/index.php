...
<div id="wrapper">
    ...
    <div class="col-md-12">
      <div class="page-header">
        <h1>Alcohol Training Certificate</h1>
      </div>
      <br />
        ...
        <div id="collapsing-bordered-table" class="collapsing-bordered-table" style="margin-top: 30px">
          ...
          <div>
            ...
            <div id="av" class="col-sm-12 col-md-3 usern">West Virginia
              <a class="course-id hidden" href="#10"></a>
            </div>
          </div>
      ...
      <br />
      <div class="row well cert-login-forms ">
        <a href="/certificate/" class="btn btn-primary" role="button">Back to Courses</a>
        <br /><br />
        <p><strong>Please Enter Your Login Information</strong></p>
        <form method="POST" action="/certificate/cert.php" class="dobform">
          <input type="hidden" name="ProID" value="alc"/>
